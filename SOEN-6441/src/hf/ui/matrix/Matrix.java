...
public class Matrix extends BasicGame
{
    ...
    public void update(GameContainer gc, int i) throws SlickException
    {
        ...
        for (LakeTile lake : ca.getLakeTiles().values())
        {
                            ...
                            + lake.getSize()))
            {
                ...
                System.out.println("lake card has " + lake.getIndex()
                        + " been selected");
            }
        }
    }
    ...
    public void render(GameContainer gc, Graphics g) throws SlickException
    {
        ...
        // g.fillRect(widthStart + j * (matrixElementlenght + gap), heightStart
        // + i * (matrixElementlenght + gap), matrixElementlenght,
        // matrixElementlenght);
        // }
        // }
        for (BasicGame entity : ca.getEntities().values())
    ...
    {
        // hf.ui.MainView.java is the one should contain every view, currently
        // it has a display slick component and a log view component
        try
        {
