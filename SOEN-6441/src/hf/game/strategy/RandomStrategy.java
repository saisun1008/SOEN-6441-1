...
{
   private static LocationEnum sitLocation = LocationEnum.TOP;
   private StringBuilder sb = new StringBuilder();
    
    /**
     * this strategy is always do random thing .
     * 
     * calculate which is random lake tile to place. calculate random
     * location.
     * 
    ...
    public boolean placeLakeTile(GameBoard board)
    {
        ...
        sb.append("current palyer is " +currentRoundPlayer.getName()+";\r\n");
        sb.append("sit in the location " + currentRoundPlayer.getSitLocation().name()+";\r\n");
        ...
        if(sitLocation == LocationEnum.TOP)
            sitLocation = LocationEnum.RIGHT;
        else  if(sitLocation == LocationEnum.RIGHT)
            sitLocation = LocationEnum.BOTTOM;
        else  if(sitLocation == LocationEnum.BOTTOM)
            sitLocation = LocationEnum.LEFT;
        else  if(sitLocation == LocationEnum.LEFT)
            sitLocation = LocationEnum.TOP;
